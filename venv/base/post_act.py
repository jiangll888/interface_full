...
class PostAct:
    ...
    def change_base_url(self,host=None):
        ...
        if not host:
            ...
            host = r[0]
            self.logger.info("没有传host，从第一个用例里用正则表达式去匹配host，匹配结果是{}".format(host))
...
if __name__ == "__main__":
    p = PostAct("get_verify_code","VerifyCode:<17625391402>","","")
    print(p.get_verify_code("VerifyCode:<17625391402>"))